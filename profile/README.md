...
| [harbor](https://github.com/stellarwp/harbor) | Bundled library that handles licensing, updates, and feature gating for WordPress plugins. |
...
| Name | Description |
|---|---|
| [Herald](https://github.com/stellarwp/herald) | High-performance licensed ZIP distribution service for WordPress plugins and themes. |
